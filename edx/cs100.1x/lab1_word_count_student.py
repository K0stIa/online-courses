...
def removePunctuation(text):
    ...
    """
    text  = re.sub("[^0-9a-zA-Z ]","", text).strip().lower()
    return text
...
# TODO: Replace <FILL IN> with appropriate code
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda s : s.split()) #shakespeareRDD.flatMap(lambda s : s.split())
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareRDD.flatMap(lambda s : s.split())
